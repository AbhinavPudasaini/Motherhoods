            ...
            [
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        { name: "clinicAccess", label: "Easy access to hospital/clinic?", type: "radio", options: ["Yes", "No"] },
                        { name: "language", label: "Preferred language", type: "select", options: ["English", "Nepali", "Hindi", "Other"] },
                    ],
                },
                {
                    key: "review",
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid gap-3">
                ...
                <Row label="Clinic access" value={form.clinicAccess} />
