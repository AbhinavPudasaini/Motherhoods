...
const Nutrition = () => {
    ...
    const [foodLog, setFoodLog] = useState([
        { id: 1, name: "Greek Yogurt with Berries", calories: 150, protein: 15, iron: 0.2, calcium: 200, image: "/cute.webp" },
        { id: 2, name: "Spinach Salad", calories: 120, protein: 8, iron: 2.5, calcium: 150, image: "/preg.webp" },
        { id: 3, name: "Grilled Salmon", calories: 280, protein: 35, iron: 1.2, calcium: 20, image: "/image1.webp" }
    ]);

    // Daily goals and current intake
    const nutritionData = {
        calories: { current: 550, goal: 2200, color: 'pink', unit: 'kcal' },
        protein: { current: 58, goal: 90, color: 'purple', unit: 'g' },
        iron: { current: 3.9, goal: 27, color: 'orange', unit: 'mg' },
        calcium: { current: 370, goal: 1200, color: 'blue', unit: 'mg' }
    };
